...
export const POST = async (request: Request) =>{
    try{
        ...
        return new NextResponse(JSON.stringify(newCategory + "Category created successfully"), {status: 200})

    }catch(error: any){
        return new NextResponse("Error adding categories" + error.message, {status:500})
    }
}
